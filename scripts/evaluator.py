...
class EvalClassifier:
    ...
    # Method to calculate log-loss
    def calculate_log_loss(self, y_true, y_pred_prob):
        """
        Calculate log loss (cross-entropy loss) for classification.
        :param confusion_matrix: confusion matrix (not used directly for log loss)
        :param metrics: metrics DataFrame (kept for consistency with other methods)
        :param y_true: true labels
        :param y_pred_prob: predicted probabilities for each class
